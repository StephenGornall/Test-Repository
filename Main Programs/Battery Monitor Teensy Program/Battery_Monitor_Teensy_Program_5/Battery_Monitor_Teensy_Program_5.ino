...
void Decode_LinkPRO_Function_Dump(){
  // Put code to request function
  // Handshake
  // Command
  // Recieve message 
  
  /* Function Dump Request 0x71
   - Function consists of 6 separate messages each with message type 0x71
   - Each message contains a different function group indicated by the first data byte
      1: System Properties
      2: Low battery alarm settings
      3: Low voltage alarm settings
      4: High voltage alarm settings
      5: Main battery properties
      6: Battery monitor properties
*/
